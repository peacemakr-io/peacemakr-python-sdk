...
from peacemakr.generated.models.tiny_org import TinyOrg  # noqa: F401,E501
...
class SymmetricKeyUseDomain(object):
    ...
    swagger_types = {
        'id': 'str',
        'owner_org_id': 'str',
        'collaborating_orgs': 'list[TinyOrg]',
        'name': 'str',
        'creation_time': 'int',
    ...
    attribute_map = {
        ...
        'collaborating_orgs': 'collaboratingOrgs',
        'name': 'name',
    ...
    def __init__(self, id=None, owner_org_id=None, collaborating_orgs=None, name=None, creation_time=None, symmetric_key_inception_ttl=None, symmetric_key_encryption_use_ttl=None, symmetric_key_encryption_allowed=None, symmetric_key_decryption_use_ttl=None, symmetric_key_decryption_allowed=None, symmetric_key_retention_use_ttl=None, symmetric_key_length=None, symmetric_key_encryption_alg='Peacemakr.Symmetric.CHACHA20_POLY1305', encrypting_packaged_ciphertext_version=None, symmetric_key_derivation_service_id=None, encryption_key_ids=None, endable_kds_fallback_to_cloud=None, require_signed_key_delivery=None, digest_algorithm='Peacemakr.Digest.SHA_256'):  # noqa: E501
        """SymmetricKeyUseDomain - a model defined in Swagger"""  # noqa: E501

        self._id = None
        self._owner_org_id = None
        self._collaborating_orgs = None
        self._name = None
        ...
        self.collaborating_orgs = collaborating_orgs
        if name is not None:
            self.name = name
    ...
    @property
    def collaborating_orgs(self):
        """Gets the collaborating_orgs of this SymmetricKeyUseDomain.  # noqa: E501

        orgs other than the owner that are allowed to use this use domain  # noqa: E501

        :return: The collaborating_orgs of this SymmetricKeyUseDomain.  # noqa: E501
        :rtype: list[TinyOrg]
        """
        return self._collaborating_orgs

    @collaborating_orgs.setter
    def collaborating_orgs(self, collaborating_orgs):
        """Sets the collaborating_orgs of this SymmetricKeyUseDomain.

        orgs other than the owner that are allowed to use this use domain  # noqa: E501

        :param collaborating_orgs: The collaborating_orgs of this SymmetricKeyUseDomain.  # noqa: E501
        :type: list[TinyOrg]
        """
        if collaborating_orgs is None:
            raise ValueError("Invalid value for `collaborating_orgs`, must not be `None`")  # noqa: E501

        self._collaborating_orgs = collaborating_orgs
