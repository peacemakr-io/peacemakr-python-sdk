...
class InstallCoreCryptoCommand(distutils.cmd.Command):
  ...
  def run(self):
    ...
    #TODO: Remove checkout when core-crypto PR is merged
    install_command = ["cd", "peacemakr-core-crypto/bin", "&&", "git", "checkout", "FIX-python-install-path", "&&", "./release-python.sh", "local", site_package_dir, "release"]
